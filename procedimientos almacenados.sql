CREATE DATABASE LIBRERIA_114253
GO
...
-- PROCEDIMIENTO PRECIOS MAS ALTOS A 100
...
-- PROCEDIMIENTO PRECIOS BAJOS

create proc pa_articulos_precios_bajos
as
select cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
where pre_unitario < 100

exec pa_articulos_precios_bajos

-- PROCEDIMIENTO CON PARAMETROS DE ENTRADA

create proc pa_articulos_precios_bajos2
@precio money
as
select cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
...
exec pa_articulos_precios_bajos2 @precio=100

alter proc pa_articulos_precios_bajos2
@precio money = 100
as
select cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
...
exec pa_articulos_precios_bajos2 @precio=500

-- PROCEDIMIENTO CON DOS ENTRADAS Y USO DE BETWEEN
